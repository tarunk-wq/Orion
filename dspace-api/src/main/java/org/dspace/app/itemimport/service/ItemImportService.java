...
public interface ItemImportService {
     ...
     * @throws Exception if error
     */
    public void replaceItems(Context c, List<DSpaceObject> mycollections, String sourcedir, String mapfile,
                             boolean template) throws Exception;
    ...
    void manageTempAccessRolePolicies(Context context, DSpaceObject dso, EPerson eperson) throws SQLException, AuthorizeException;

	void deleteTempAccessRolePolicies(Context context, DSpaceObject dso, EPerson eperson) throws SQLException, AuthorizeException;
}
