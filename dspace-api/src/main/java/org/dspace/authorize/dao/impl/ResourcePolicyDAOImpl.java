...
public class ResourcePolicyDAOImpl extends AbstractHibernateDAO<ResourcePolicy> implements ResourcePolicyDAO {
    ...
    @Override
	public List<ResourcePolicy> findByEpersonAction(Context context, DSpaceObject dso, EPerson ePerson, int action) throws SQLException {
		// TODO Auto-generated method stub
		CriteriaBuilder criteriaBuilder = getCriteriaBuilder(context);
	    CriteriaQuery<ResourcePolicy> criteriaQuery = getCriteriaQuery(criteriaBuilder, ResourcePolicy.class);
	    Root<ResourcePolicy> resourcePolicyRoot = criteriaQuery.from(ResourcePolicy.class);
	    criteriaQuery.select(resourcePolicyRoot);
