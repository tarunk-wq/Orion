...
public class ResourcePolicyServiceImpl implements ResourcePolicyService {
    ...
    @Override
	public List<ResourcePolicy> find(Context context, DSpaceObject dso, EPerson eperson, int action) throws SQLException {
		// TODO Auto-generated method stub
		return resourcePolicyDAO.findByEpersonAction(context, dso, eperson, action);
	}
}
