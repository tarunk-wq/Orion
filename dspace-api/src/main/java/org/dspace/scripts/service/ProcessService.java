...
public interface ProcessService {
    ...
    List<Process> search(Context context, ProcessQueryParameterContainer processQueryParameterContainer, int limit,
            int offset, Date startDate, Date endDate) throws SQLException;
    ...
    int countSearch(Context context, ProcessQueryParameterContainer processQueryParameterContainer, Date startDateObj,
			Date endDateObj) throws SQLException;
	...
	List<Process> findByStatusCollectionAndBatchName(Context context, String batchName, String scriptName,
			Collection collection, Date startDate, Date endDate, ProcessStatus status) throws SQLException;

	List<Process> findByBatchNameImportCompleted(Context context, String batchName) throws SQLException;

	List<Process> findByBatchNameCompleted(Context context, String batchName) throws SQLException;

	List<Process> findByBatchName(Context context, String batchName) throws SQLException;
}
