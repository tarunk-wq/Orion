...
public interface AuthenticationMethod {
    ...
    /*
     * User Locked out due to exceeding unsuccessful attempts
     */
    public static final int LOCK_OUT = 6;
    ...
    /*
     * User has be disabled from login
     */
     ...
     * <br>LOCK_OUT		   - user locked out
     * <br>PASSWORD_EXPIRED- user password expired
     * @throws SQLException if database error
     */
