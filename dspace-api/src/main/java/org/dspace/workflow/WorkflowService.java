...
public interface WorkflowService<T extends WorkflowItem> {
	...
	public void startBatchWorkflow(Context c, String batchName, DSpaceObject dspaceParent) throws SQLException, AuthorizeException, IOException, WorkflowException;

	Group createWorkflowRoleGroup(Context context, Community community, String roleName)
			throws AuthorizeException, SQLException, IOException, WorkflowConfigurationException;
	
	Group getWorkflowRoleGroup(Context context, DSpaceObject dSpaceObject, String roleName, Group roleGroup)
			throws SQLException, IOException, WorkflowException, AuthorizeException;

	void deleteCommunity(Context context, Community community) throws SQLException, IOException, AuthorizeException;
}
