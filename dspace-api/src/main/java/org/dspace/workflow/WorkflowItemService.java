...
public interface WorkflowItemService<T extends WorkflowItem> extends InProgressSubmissionService<T> {
     ...
     */
    public T create(Context context, Item item, DSpaceObject parent) throws SQLException, AuthorizeException;
	...
	void deleteByCommunity(Context context, Community community) throws SQLException, IOException, AuthorizeException;
