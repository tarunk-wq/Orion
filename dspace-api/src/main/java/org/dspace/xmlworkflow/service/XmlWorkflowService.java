...
public interface XmlWorkflowService extends WorkflowService<XmlWorkflowItem> {
	...
	void startBatchWorkflow(Context context, String batchname, DSpaceObject dspaceParent)
			throws SQLException, AuthorizeException, IOException, WorkflowException;

	WorkspaceItem sendEachWorkflowItemBackSubmission(Context context, XmlWorkflowItem wi, EPerson e, String provenance,
			String rejection_message, Item myitem) throws SQLException, AuthorizeException, IOException;

	public void closeWorkflow(Context c, XmlWorkflowItem wfi) throws SQLException, IOException, AuthorizeException;

	Group createWorkflowRoleGroup(Context context, Community community, String roleName)
