...
public class ClaimedTaskDAOImpl extends AbstractHibernateDAO<ClaimedTask> implements ClaimedTaskDAO {
    ...
    @Override
   	public int countRows(Context context) throws SQLException {
            ...
            return count(context, criteriaQuery, criteriaBuilder, claimedTaskRoot);
   	}

	@Override
	public List<ClaimedTask> findByEperson(Context context, EPerson ePerson, int limit, int offset)
			throws SQLException {
		CriteriaBuilder criteriaBuilder = getCriteriaBuilder(context);
        CriteriaQuery<ClaimedTask> criteriaQuery = getCriteriaQuery(criteriaBuilder, ClaimedTask.class);
        Root<ClaimedTask> claimedTaskRoot = criteriaQuery.from(ClaimedTask.class);
        criteriaQuery.select(claimedTaskRoot);
        criteriaQuery.where(criteriaBuilder.equal(claimedTaskRoot.get(ClaimedTask_.owner), ePerson));
        return list(context, criteriaQuery, false, ClaimedTask.class, limit, offset);
	}
}
