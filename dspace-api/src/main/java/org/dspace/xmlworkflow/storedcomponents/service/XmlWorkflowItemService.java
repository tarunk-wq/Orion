...
public interface XmlWorkflowItemService extends WorkflowItemService<XmlWorkflowItem> {
	...
	XmlWorkflowItem create(Context context, String batchname) throws SQLException, AuthorizeException;

	void updateBatch(Context context, XmlWorkflowItem workflowItem) throws SQLException, AuthorizeException;

	List<XmlWorkflowItem> findByCommunity(Context context, Community community) throws SQLException;
