...
public class XmlWorkflowItem implements WorkflowItem {
	...
	public UUID[] getItem_ids() {
		return item_ids;
	}

	public void setItem_ids(UUID[] item_ids) {
