...
public class ClaimedTaskServiceImpl implements ClaimedTaskService {
    ...
    @Override
    public List<ClaimedTask> findAll(Context context, int limit, int offset) throws SQLException {
        return claimedTaskDAO.findAll(context, ClaimedTask.class, limit, offset);
    }
    ...
    public int countTotal(Context context) throws SQLException {
        return claimedTaskDAO.countRows(context);
    }
    
    @Override
    public List<ClaimedTask> findByEperson(Context context, EPerson ePerson, int limit, int offset) throws SQLException {
        return claimedTaskDAO.findByEperson(context, ePerson, limit, offset);
    }
}
