...
public interface ClaimedTaskService extends DSpaceCRUDService<ClaimedTask> {
	...
	List<ClaimedTask> findByEperson(Context context, EPerson ePerson, int limit, int offset) throws SQLException;

	int countTotal(Context context) throws SQLException;

	List<ClaimedTask> findAll(Context context, int limit, int offset) throws SQLException;
}
