...
public interface ItemDAO extends DSpaceObjectLegacySupportDAO<Item> {
	...
	Iterator<Item> findArchivedByCommunity(Context context, Community community, Integer limit, Integer offset)
			throws SQLException;

	List<Item> findByCustomNativeQuery(Context context, String nativeQuery, Map<String, Object> params) throws SQLException;
