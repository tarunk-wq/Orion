 ...
 * Payload example:
 *
 * { "bundle": "A|B", "file": "base64encodedstring", "metadata": { "dc.title":
 * "Example Title" } }
 *
...
public class SingleUploadRequest {
	...
	/**
	 * Bundle hierarchy string Example: "A|B"
	 */
	...
	// Optional description for bitstream
	private String description;

	// Group ID for policy creation (UUID string in new system)
	private String groupId;

	// Optional access start date fields
