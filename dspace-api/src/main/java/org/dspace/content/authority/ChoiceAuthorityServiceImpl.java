...
//            DCInputsReader dcInputsReader = new DCInputsReader();
        	...
        	List<String> allSubDepartmentHandle = userMetadataFieldsService.findAllSubDepartmentHandle(context);
        	DynamicInputSetFactory dynamicInputSetFactory = new DynamicInputSetFactory();
...
//                List<DCInputSet> inputsBySubmissionName = dcInputsReader.getInputsBySubmissionName(submissionName);
        	 for (String handle : allSubDepartmentHandle) {
                 String submissionName = "dynamicForm";
                 List<DCInputSet> inputsBySubmissionName = dynamicInputSetFactory.buildForSection(context, handle);
