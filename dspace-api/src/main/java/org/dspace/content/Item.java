...
public class Item extends DSpaceObject implements DSpaceObjectLegacySupport {
    ...
    @ManyToOne(fetch = FetchType.LAZY, cascade = {CascadeType.PERSIST})
    @JoinColumn(name = "owning_community")
    ...
    /**
     * Get the communities this item is in. The order is sorted ascending by Community name.
     *
     * @return the communities this item is in, if any.
     */
    public List<Community> getCommunities() {
        // We return a copy because we do not want people to add elements to this Community directly.
        // We return a list to maintain backwards compatibility
	...
	public void setOwningCommunity(Community owningCommunity) {
		this.owningCommunity = owningCommunity;
	}
	
	public DSpaceObject getOwningParent() {
		if (owningCollection != null) {
			return owningCollection;
		} else if (owningCommunity != null) {
			return owningCommunity;
		}
		return null;
	}
    
	public EPerson getVerifier() {
		return verifier;
	}

	public void setVerifier(EPerson verifier) {
		this.verifier = verifier;
	}

	public EPerson getEditor() {
		return editor;
	}

	public void setEditor(EPerson editor) {
		this.editor = editor;
	}
	...
	public EPerson getCheckoutBy() {
		return checkoutBy;
	}

	public void setCheckoutBy(EPerson checkoutBy) {
