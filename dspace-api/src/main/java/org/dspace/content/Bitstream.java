...
public class Bitstream extends DSpaceObject implements DSpaceObjectLegacySupport {
    ...
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "bitstream")
    private VersionBitstream versionBitstream;

    @Transient
    private transient BitstreamService bitstreamService;
    
    public void setVersionBitstream(VersionBitstream versionBitstream) {
		this.versionBitstream = versionBitstream;
	}
