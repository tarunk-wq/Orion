...
public class LicenseUtils {
	...
	public static String getLicenseText(Locale locale, DSpaceObject parent, Item item, EPerson eperson,
		...
		if(parent instanceof Collection) {
			args[4] =  new FormattableArgument("collection", parent);
		} else if ( parent instanceof Community) {
			args[4] =  new FormattableArgument("community", parent);
		}
		args[5] = new FormattableArgument("item", item);
		args[6] = new FormattableArgument("eperson", eperson);
		...
		if(parent instanceof Collection) {
			 licenseTemplate = collectionService.getLicense((Collection) parent);
		} else if (parent instanceof Community) {
			licenseTemplate = communityService.getLicense((Community) parent);
		}
    ...
    public static String getLicenseText(Locale locale, DSpaceObject parent,
            Item item, EPerson eperson) {
	return getLicenseText(locale, parent, item, eperson, null);
	}
