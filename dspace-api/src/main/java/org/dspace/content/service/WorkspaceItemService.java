...
public interface WorkspaceItemService extends InProgressSubmissionService<WorkspaceItem> {
	...
	WorkspaceItem create(Context context, Community community, UUID uuid, boolean template)
			throws AuthorizeException, SQLException;

	WorkspaceItem createXML(Context c, XmlWorkflowItem workflowItem, Item item) throws SQLException, AuthorizeException;

	List<WorkspaceItem> findByCommunity(Context context, Community community) throws SQLException;
