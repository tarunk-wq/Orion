...
public interface CommunityService extends DSpaceObjectService<Community>, DSpaceObjectLegacySupportService<Community> {
	...
	void save(Context context, Community community) throws SQLException;


	void addItem(Context context, Community community, Item item) throws SQLException, AuthorizeException;


	void removeItem(Context context, Community community, Item item) throws SQLException, AuthorizeException;


	String getLicense(Community community);


	List<Community> findCommunitiesWithSubmit(String q, Context context, Community community)
			throws SQLException, SearchServiceException;


	List<Community> findCommunitiesWithSubmit(String q, Context context, Community community, int offset, int limit)
			throws SQLException, SearchServiceException;


	int countCommunitiesWithSubmit(String q, Context context, Community community)
			throws SQLException, SearchServiceException;
	
	void updateDuplicacyCheck(Context context, UUID subDepartmentId, Boolean enabled) throws SQLException, AuthorizeException;
}
