...
public interface CollectionService
	...
	void save(Context context, Collection collection) throws SQLException, AuthorizeException;

	void removeCollectionMapping(Context context, Collection collection, Item item)
			throws SQLException, AuthorizeException;
}
