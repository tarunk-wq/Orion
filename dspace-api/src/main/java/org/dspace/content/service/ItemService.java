...
public interface ItemService
    ...
    */
	...
	Iterator<Item> findAllByCommunity(Context context, Community community) throws SQLException;
	
	void moveToCommunity(Context context, Item item, Community from, Community to, boolean inheritDefaultPolicies) throws SQLException, AuthorizeException, IOException;
	
	default void moveToCommunity(Context context, Item item, Community from, Community to) throws SQLException, AuthorizeException, IOException {
	    moveToCommunity(context, item, from, to, false);
	}
	
	void moveItemCollectionToCommunity(Context context, Item item, Collection from, Community to, boolean inheritDefaultPolicies) throws SQLException, AuthorizeException, IOException;
	
	default void moveItemCollectionToCommunity(Context context, Item item, Collection from, Community to) throws SQLException, AuthorizeException, IOException {
		moveItemCollectionToCommunity(context, item, from, to, false);
	}
	
	void moveItemCommunityToCollection(Context context, Item item, Community from, Collection to, boolean inheritDefaultPolicies) throws SQLException, AuthorizeException, IOException;
	
	default void moveItemCommunityToCollection(Context context, Item item, Community from, Collection to) throws SQLException, AuthorizeException, IOException {
		moveItemCommunityToCollection(context, item, from, to, false);
	}

	void inheritCollectionDefaultPolicies(Context context, Item item, DSpaceObject parent,
			boolean replaceReadRPWithCollectionRP) throws SQLException, AuthorizeException;

	void adjustItemPolicies(Context context, Item item, DSpaceObject parent, boolean replaceReadRPWithCollectionRP) throws SQLException, AuthorizeException;

	void adjustBundleBitstreamPolicies(Context context, Item item, DSpaceObject parent,
			boolean replaceReadRPWithCollectionRP) throws SQLException, AuthorizeException;

	int countVerifiedRows(Context context) throws SQLException;

	int countVerifiedAndUpdatedRows(Context context) throws SQLException;

	void checkout(Context context, UUID itemId, EPerson ePerson, String action) throws SQLException, AuthorizeException;

	boolean isOwningCommunity(Item item, Community community);
	
	List<Item> findByCustomNativeQuery(Context context, String nativeQuery) throws SQLException;

	List<Item> findByCustomNativeQuery(Context c, String hql, Map<String, Object> params) throws SQLException;
	
	Iterator<Object[]> getItemUploadReport(Context context, List<Community> subCommunities,
			List<Collection> subCollections, MetadataField[] metadataFields) throws SQLException;

	Iterator<Object[]> getBatchUploadReport(Context context, List<Community> subCommunities,
			List<Collection> subCollections, MetadataField[] metadataFields) throws SQLException;

	List<Object[]> findByEachTypeCount(Context context, List<Community> subCommunities, List<Collection> subCollections,
