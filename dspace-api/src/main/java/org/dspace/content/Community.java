...
public class Community extends CacheableDSpaceObject implements DSpaceObjectLegacySupport {
	...
	@Column(name = "is_duplicate_check_enabled")
	private Boolean isDuplicateCheckEnabled = false;
	
    public Boolean getIsDuplicateCheckEnabled() {
		return isDuplicateCheckEnabled;
	}

	public void setIsDuplicateCheckEnabled(Boolean isDuplicateCheckEnabled) {
		this.isDuplicateCheckEnabled = isDuplicateCheckEnabled;
	}
