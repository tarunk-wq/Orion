...
public class BitstreamServiceImpl extends DSpaceObjectServiceImpl<Bitstream> implements BitstreamService {
    ...
    @Override
    public void updateDocument(Context context, Bitstream oldBitstream, InputStream inputStream) {
        
        try {
            bitstreamStorageService.store(context, oldBitstream, inputStream);
        } catch (Exception e) {
            log.error("Error in updating bitstream",e);
        }
