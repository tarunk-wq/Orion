...
public class EPerson extends CacheableDSpaceObject implements DSpaceObjectLegacySupport {
    ...
    @Column(name = "last_wrong_attempt_time")
    private Instant lastWrongAttemptTime;

    @Column(name = "token_expiration_time")
    private Instant tokenExpirationTime;
    
    @Column(name = "session_jwt_token",columnDefinition="text")
    private String sessionJWTToken;
    
    @Column(name = "shortlived_token",columnDefinition="text")
    private String shortLivedToken;

    @Column(name = "eperson_ip_address")
    private String epersonIPAddress;
    ...
    private List<Item> itemVerified;
    
    @OneToMany(mappedBy = "editor")
    private List<Item> itemEdited;
    
    @Column(name = "unsuccessful_attempts", columnDefinition = "int default 0")
	...
	public void setSessionJWTToken(String sessionJWTToken) {
	...
	public String getEpersonIPAddress() {
		return epersonIPAddress;
	}

	public void setEpersonIPAddress(String epersonIPAddress) {
		this.epersonIPAddress = epersonIPAddress;
	}
	...
	/**
	 * capture last time user used wrong credential to login
	 * 
	 * @return
	 */

	public Instant getLastWrongAttemptTime() {
		return lastWrongAttemptTime;
	}

	public void setLastWrongAttemptTime(Instant lastWrongAttemptTime) {
		this.lastWrongAttemptTime = lastWrongAttemptTime;
	}
}
