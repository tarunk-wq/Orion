...
public interface GroupService extends DSpaceObjectService<Group>, DSpaceObjectLegacySupportService<Group> {
	...
	Group createGroupByName(Context context, String name) throws SQLException, AuthorizeException;

	List<Group> findByFolder(Context context, String folderName) throws SQLException;

	List<Group> findGroupsAssignedToFolder(Context context, UUID folderId) throws SQLException;
}
