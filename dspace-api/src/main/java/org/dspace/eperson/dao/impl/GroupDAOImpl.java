...
public class GroupDAOImpl extends AbstractHibernateDSODAO<Group> implements GroupDAO {
    ...
    @Override
	public List<Group> findByFolder(Context context, String folderId) throws SQLException {
	    String queryString = "FROM Group WHERE name LIKE :folderId";
	...
	public List<Group> findGroupsAssignedToFolder(Context context, UUID folderId) throws SQLException {
		String queryString = "SELECT rp.epersonGroup FROM ResourcePolicy rp WHERE rp.dSpaceObject.id = :folderId";
	    Query query = createQuery(context, queryString)
	                    .setParameter("folderId", folderId);
	    return list(query);
	}
