...
public class ShortLivedJWTTokenHandlerTest extends JWTTokenHandlerTest {
    ...
    public void testJWTNoEncryption() throws Exception {
        ...
        String token = shortLivedJWTTokenHandler
            .createTokenForEPerson(context, new MockHttpServletRequest(), previous, true);
    ...
    public void testExpiredToken() throws Exception {
        ...
        String token = shortLivedJWTTokenHandler
            .createTokenForEPerson(context, new MockHttpServletRequest(), previous, true);
        EPerson parsed = shortLivedJWTTokenHandler.parseEPersonFromToken(token, httpServletRequest, context, true);
    ...
    public void testTokenTampering() throws Exception {
        ...
        EPerson parsed = shortLivedJWTTokenHandler.parseEPersonFromToken(tamperedToken, httpServletRequest, context, true);
        assertEquals(null, parsed);
    }
