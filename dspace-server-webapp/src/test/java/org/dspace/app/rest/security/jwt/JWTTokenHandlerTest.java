...
public class JWTTokenHandlerTest {
    ...
    public void testJWTNoEncryption() throws Exception {
        ...
        String token = loginJWTTokenHandler
            .createTokenForEPerson(context, new MockHttpServletRequest(), previous, false);
    ...
    public void testExpiredToken() throws Exception {
        ...
        String token = loginJWTTokenHandler
            .createTokenForEPerson(context, new MockHttpServletRequest(), previous, false);
        EPerson parsed = loginJWTTokenHandler.parseEPersonFromToken(token, httpServletRequest, context, false);
    ...
    public void testTokenTampering() throws Exception {
        ...
        EPerson parsed = loginJWTTokenHandler.parseEPersonFromToken(tamperedToken, httpServletRequest, context, false);
        assertEquals(null, parsed);
    }
