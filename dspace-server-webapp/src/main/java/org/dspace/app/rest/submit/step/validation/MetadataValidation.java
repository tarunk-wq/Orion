            ...
            for (DCInput input : row) {
                ...
                if (input.isQualdropValue()) {
                    ...
                    for (int i = 1; i < inputPairs.size(); i += 2) {
                        ...
                        List<MetadataValue> mdv = itemService.getMetadataByMetadataString(item, fullFieldname);
                ...
                for (String fieldName : fieldsName) {
                    ...
                    List<MetadataValue> mdv = itemService.getMetadataByMetadataString(item, fieldName);
